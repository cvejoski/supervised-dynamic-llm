...
# -- Project information -----------------------------------------------------
project = "kiwissen-base"
copyright = "2021-2023, KI Wissen"
author = "KI Wissen"

release = os.getenv("VERSION", default="0.1.0")
...
# -- Configuration for publishing to Confluence ------------------------------
confluence_parent_page = "DOCTEST"
confluence_server_user = "user"
confluence_publish = False  # Set to true to enable Confluence publishing
confluence_publish_dryrun = False
confluence_page_hierarchy = True
confluence_server_url = "https://confluence.vdali.de"
confluence_space_name = "KIWissen"
